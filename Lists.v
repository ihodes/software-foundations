...
Theorem adding_increments_bag : forall l:natlist, forall v:nat,
...
Theorem rapp_nil_nop : forall l1 : natlist,
  l1 ++ [] = l1.
Proof.
  intros l1.
  induction l1.
...
Proof.
  ...
  induction l1.
  simpl.
  rewrite rapp_nil_nop. reflexivity.
  simpl. rewrite IHl1. rewrite snoc_append. rewrite app_assoc. rewrite snoc_append. reflexivity. Qed.
...
Proof.
  ...
  rewrite <- rev_involutive. rewrite <- H. simpl. rewrite rev_snoc.
...
Proof.
  ...
  simpl.
  induction d.
  simpl. rewrite beq_self_t. reflexivity.
  rewrite beq_self_t. reflexivity. Qed.
